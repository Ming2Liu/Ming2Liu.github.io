...
<div style="display: flex; gap: 30px; margin-bottom: 50px; align-items: flex-start;">
  <div style="flex-shrink: 0;">
    <img src="https://ming2liu.github.io/files/mm_pic1.jpg" alt="Noureddine Boujnah"
         style="width: 250px; border-radius: 12px; object-fit: cover;" />
  </div>
  <div style="flex: 1;">
    <h2 style="color: #1e90ff; font-size: 24px; margin: 0 0 10px 0;">yyy</h2>
    <p style="color: #dddddd; font-size: 16px; line-height: 1.6; margin-top: 0;">
...
<div style="display: flex; gap: 30px; margin-bottom: 50px; align-items: flex-start;">
  ...
  <div style="flex: 1;">
    <h2 style="color: #1e90ff; font-size: 24px; margin: 0 0 10px 0;">Sen Yan</h2>
    <p style="color: #dddddd; font-size: 16px; line-height: 1.6; margin-top: 0;">
...
<div style="display: flex; gap: 30px; margin-bottom: 50px; align-items: flex-start;">
  ...
  <div style="flex: 1;">
    <h2 style="color: #1e90ff; font-size: 24px; margin: 0 0 10px 0;">Yue Ding</h2>
    <p style="color: #dddddd; font-size: 16px; line-height: 1.6; margin-top: 0;">
        Yue Ding received her B.Sc. (Double Degree) in E-Commerce Engineering with Law from Queen Mary University of London and Beijing University of Posts and Telecommunications in 2022, and her M.Sc. in Computer Science – Future Networked Systems from Trinity College Dublin in 2023. Her research focuses on optimizing smart transportation systems using reinforcement learning (RL) and other AI techniques to tackle complex, multi-objective problems in traffic management, route planning, and resource allocation. She is particularly interested in integrating explainable AI to ensure transparency and interpretability in real-world mobility solutions.
    </p>
  </div>
</div>
...
<div style="display: flex; gap: 30px; margin-bottom: 50px; align-items: flex-start;">
  ...
  <div style="flex: 1;">
    <h2 style="color: #1e90ff; font-size: 24px; margin: 0 0 10px 0;">Francesco Chiumento</h2>
    <p style="color: #dddddd; font-size: 16px; line-height: 1.6; margin-top: 0;">
       Francesco Chiumento is a PhD researcher at ML-Labs with a Master's degree in Bioengineering from Università di Padova. His research focuses on developing and evaluating a specialized Large Language Model (LLM) tailored for medical imaging diagnostics, addressing the current gap in LLMs’ ability to process and interpret complex visual data.    
    </p>
  </div>
</div>
...
<div style="display: flex; gap: 30px; margin-bottom: 50px; align-items: flex-start;">
  ...
  <div style="flex: 1;">
    ...
    <p style="color: #dddddd; font-size: 16px; line-height: 1.6;">
      His research bridges mathematical optimization, computer science, and electrical engineering — particularly focusing on selecting optimal solutions under a defined criterion.
    </p>
    <p style="color: #dddddd; font-size: 16px; line-height: 1.6;">
      His work contributes to the theoretical and practical advancements of optimization algorithms in intelligent systems.
    </p>
  </div>
</div>
